...
port          = 1883
clean_session = True
client_id     = "glub2electricboogaloo@gmail.com"
user_name     = "BrenKursek"
...
def on_message(client, userdata, msg):
    ...
    if message == "Fire":
        ...
        #Unable to complete due to technology issues
        #fire.startWatch()
        fire.simulatedWatch()
        
         # publish message (optionally configuring qos=1, qos=2 and retain=True/False)
        ret = client.publish ("Bren", "Target Down")
        client.loop ()
